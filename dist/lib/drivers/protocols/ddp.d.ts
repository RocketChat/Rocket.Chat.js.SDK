...
export declare class Socket extends EventEmitter {
     ...
     */
    send(obj: any, msg?: boolean | string, errorMsg?: string): Promise<any>;
    ...
    onEvent(id: string, collection: string, callback: ISocketMessageCallback): void;
    /**
...
export declare class DDPDriver extends EventEmitter implements IDriver {
    logger: ILogger;
