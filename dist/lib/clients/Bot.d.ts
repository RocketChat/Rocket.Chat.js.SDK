...
import { ISocketOptions, IRespondOptions, ICallback, IMessageCallback, IMessage, IMessageReceipt, ISubscription, ICredentials } from '../../interfaces';
...
export default class BotClient extends Rocketchat {
    ...
    joinRoom(room: string): Promise<RID>;
    ...
    getRoomNameById(rid: string): Promise<string>;
}
