...
- What a close does to the subscription map is settled by ADR-0004, which forgets
  every entry on this path because no DDP response can arrive to decide one.
